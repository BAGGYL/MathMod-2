setwd("D:/Group 124/Mathmod Vershennik/Mathmod") 
...
mod1=lm(h2o_flux~(DOY+Tau+rand_err_Tau + H+rand_err_H +LE+ rand_err_LE +co2_flux+rand_err_co2_flux+ rand_err_h2o_flux + H_strg + co2_molar_density +h2o_time_lag + sonic_temperature + 
                    air_temperature+air_density+air_molar_volume+es+RH+VPD+u_star_+TKE+T_star_+un_H+un_Tau+un_H+un_LE+un_co2_flux+un_h2o_flux)^2,data=tbl) 
mod1 
coef(mod1) 
resid(mod1) 
confint(mod1) 
...
mod2=lm(h2o_flux~(DOY+Tau+rand_err_Tau + H+rand_err_H +LE+ rand_err_LE +co2_flux+rand_err_co2_flux+ rand_err_h2o_flux + H_strg + co2_molar_density +h2o_time_lag + sonic_temperature + 
                    air_temperature+air_density+air_molar_volume+es+RH+VPD+u_star_+TKE+T_star_+un_H+un_Tau+un_H+un_LE+un_co2_flux+un_h2o_flux)^2-LE:air_density -LE:co2_flux-rand_err_H:un_co2_flux -H:un_LE-H:TKE,data=tbl)
coef(mod2)
resid(mod2)
confint(mod2)
summary(mod2)
